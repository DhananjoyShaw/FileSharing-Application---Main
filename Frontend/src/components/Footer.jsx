const Footer = () => {
    return (
        <>
            <div className="w-full bg-black px-8 md:px-[200px] flex flex-col md:flex-row space-y-6 md:space-y-0 items-start md:items-center justify-between text-sm md:text-md py-8">
